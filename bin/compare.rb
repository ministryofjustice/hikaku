...
pages = [
  ...
  { app: 'steps/cost/start',                   prototype: 'before_you_start/start' },
  { app: 'steps/cost/challenged_decision',     prototype: 'before_you_start/hmrc_challenge' },
  { app: 'steps/cost/case_type',               prototype: 'before_you_start/type_of_tax' },
  { app: 'steps/cost/dispute_type',            prototype: 'before_you_start/dispute_type' },
  { app: 'steps/cost/penalty_amount',          prototype: 'before_you_start/penalty_detail' },
  { app: 'steps/cost/determine_cost',          prototype: 'before_you_start/fee' },
  ...
  { app: 'steps/details/individual_details',   prototype: 'data_capture/appellant_details' },
  ...
  { app:  not_yet,                             prototype: 'data_capture/outcome' },
