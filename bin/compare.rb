...
pages = [
  ...
  { app: 'steps/appeal/start',                    prototype: 'no_fees' },
  ...
  # { app: 'steps/details/user_type',               prototype: 'data_capture/who_are_you' },
  { app: 'steps/details/taxpayer_type',           prototype: 'data_capture/appellant_type' },
  { app: 'steps/details/taxpayer_details',        prototype: 'data_capture/appellant_details' },
  { app: 'steps/details/has_representative',      prototype: 'data_capture/do_you_have_rep' },
  # { app: 'steps/details/representative_type',     prototype: 'data_capture/representative_type' },
  # { app: 'steps/details/representative_details',  prototype: 'data_capture/representative_details' },
